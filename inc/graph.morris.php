...
class Rockstar_Graph_Morris extends Rockstar_Graph_Abstract {

	public function register_script() {
		wp_register_style( 'morris', plugins_url( '/css/morris.css', dirname( __FILE__ ) ), array(), '0.4.3' );
		wp_enqueue_style( 'morris' );

		wp_register_script( 'morris', plugins_url( '/js/morris.min.js', dirname( __FILE__ ) ), array( 'jquery', 'raphael' ), '0.4.3' );
